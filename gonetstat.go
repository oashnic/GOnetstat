...
func netstatByPort(t string, p int64) []Process {
...
func getCountConnectionsByPort(t string, p int64) int {
	data := getData(t)
	count := 0
...
func TcpByPort(port int64) []Process {
	return netstatByPort("tcp", port)
}

func UdpByPort(port int64) []Process {
	return netstatByPort("udp", port)
}

func Tcp6ByPort(port int64) []Process {
	return netstatByPort("tcp6", port)
}

func Udp6ByPort(port int64) []Process {
	return netstatByPort("udp6", port)
}

func CountTcp() int {
	return len(getData("tcp"))
}

func CountUdp() int {
	return len(getData("udp"))
}

func CountUdp6() int {
	return len(getData("udp6"))
}

func CountTcp6() int {
	return len(getData("tcp6"))
}

func CountTcpByPort(port int64) int {
	return getCountConnectionsByPort("tcp", port)
}

func CountUdpByPort(port int64) int {
	return getCountConnectionsByPort("udp", port)
}

func CountTcp6ByPort(port int64) int {
	return getCountConnectionsByPort("tcp6", port)
}

func CountUdp6ByPort(port int64) int {
	return getCountConnectionsByPort("udp6", port)
}
